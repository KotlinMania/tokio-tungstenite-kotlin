...
This file is the quick-reference operating contract for tokio-tungstenite-kotlin. The longer
...
tokio-tungstenite-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`tokio-tungstenite`](https://crates.io/crates/tokio-tungstenite). Upstream Rust is the behavioral oracle while the
