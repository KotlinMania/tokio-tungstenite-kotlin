...
// of the pipeline:
//
//   1. `embedSwiftExportForXcode` produced `TokioTungstenite.swiftmodule/`
...
//      `import TokioTungstenite` above would fail at compile time.
//
//   2. The static archive `libTokioTungstenite.a` (produced by the
...
//      architecture arm64".
//
//   3. The Kotlin `swiftExport { moduleName = "TokioTungstenite" }` and
//      `flattenPackage = "io.github.kotlinmania.tokiotungstenite"` configuration in
...
//      via the `TokioTungsteniteLibrary` product.
//
...
final class TokioTungsteniteExportTests: XCTestCase {
    func testSwiftModuleLoads() throws {
        XCTAssertTrue(true, "TokioTungstenite swift module imported cleanly")
    }
}
