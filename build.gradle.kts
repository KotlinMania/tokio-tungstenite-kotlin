...
kotlin {
    ...
    val xcf = XCFramework("TokioTungstenite")

    macosArm64 {
        binaries.framework { baseName = "TokioTungstenite"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "TokioTungstenite"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "TokioTungstenite"
        flattenPackage = "io.github.kotlinmania.tokiotungstenite"
    }

    android {
        namespace = "io.github.kotlinmania.tokiotungstenite"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "tokio-tungstenite-kotlin", version.toString())

    pom {
        name.set("tokio-tungstenite-kotlin")
        description.set("Kotlin Multiplatform port of snapview/tokio-tungstenite - Tokio binding for Tungstenite, the Lightweight stream-based WebSocket implementation")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/tokio-tungstenite-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/tokio-tungstenite-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/tokio-tungstenite-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/tokio-tungstenite-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleTokioTungsteniteXCFramework",
    "assembleTokioTungsteniteDebugXCFramework",
    "assembleTokioTungsteniteReleaseXCFramework",
    "assembleDebugIosFatFrameworkForTokioTungsteniteXCFramework",
    "assembleReleaseIosFatFrameworkForTokioTungsteniteXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForTokioTungsteniteXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForTokioTungsteniteXCFramework",
    "assembleDebugMacosFatFrameworkForTokioTungsteniteXCFramework",
    "assembleReleaseMacosFatFrameworkForTokioTungsteniteXCFramework",
    "assembleDebugTvosFatFrameworkForTokioTungsteniteXCFramework",
    "assembleReleaseTvosFatFrameworkForTokioTungsteniteXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForTokioTungsteniteXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForTokioTungsteniteXCFramework",
    "assembleDebugWatchosFatFrameworkForTokioTungsteniteXCFramework",
    "assembleReleaseWatchosFatFrameworkForTokioTungsteniteXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForTokioTungsteniteXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForTokioTungsteniteXCFramework",
