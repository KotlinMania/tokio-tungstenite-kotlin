...
**Target:** src/commonMain/kotlin/io/github/kotlinmania/tokiotungstenite
...
| `src/commonMain/kotlin/io/github/kotlinmania/tokiotungstenite/TungsteniteTypes.kt` | `// port-lint: source lib.rs` | `// port-lint: source lib.rs` | `lib.rs` | `port-lint provenance header matched only after fallback normalization: 'lib.rs' vs expected 'lib.rs'` |
...
| `src/commonTest/kotlin/io/github/kotlinmania/tokiotungstenite/StreamTest.kt` | `// port-lint: tests stream.rs` | `// port-lint: tests stream.rs` | `stream.rs` | `port-lint provenance header matched only after fallback normalization: 'tests:stream.rs' vs expected 'stream.rs'` |
...
| `src/commonTest/kotlin/io/github/kotlinmania/tokiotungstenite/ConnectTest.kt` | `// port-lint: tests connect.rs` | `// port-lint: tests connect.rs` | `connect.rs` | `port-lint provenance header matched only after fallback normalization: 'tests:connect.rs' vs expected 'connect.rs'` |
